...
public class MainActivity extends Activity implements OnTouchListener, TextToSpeech.OnInitListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		bmOrginalLion4=BitmapFactory.decodeResource(this.getResources(), R.drawable.lion_4);
		...
		solve.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				//
				//					solve.setText("RESTART");
				//
				//				}
				solve();


				//((MyCountDownTimer) countDownTimer).redraw();
			}
		...
		anim.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				TranslateAnimation animation = new TranslateAnimation(1,960,1,340);
				animation.setDuration(1000);
				//  animation.setRepeatCount(5);
				//  animation.setRepeatMode(2);
				animation.setFillAfter(true);
				image0.startAnimation(animation);
				//fiximage4.setAnimation(animation);
			    animation.hasEnded();
				//fiximage4.setImageBitmap(bmResizedLion44);
			    //fiximage4.setImageResource(bmResizedLion44);
			}
	...
	private void redraw() {
		...
		// TODO Auto-generated method stub
		image0.setImageBitmap(bmOrginalLion44);
		image1.setImageBitmap(bmOrginalLion88);
		image2.setImageBitmap(bmOrginalLion33);
		image3.setImageBitmap(bmOrginalLion77);
		image4.setImageBitmap(bmOrginalLion22);
		image5.setImageBitmap(bmOrginalLion66);
		image6.setImageBitmap(bmOrginalLion11);
		image7.setImageBitmap(bmOrginalLion55);
		image8.setImageBitmap(bmOrginalLion00);
		fiximage0.setImageDrawable(null);
		fiximage1.setImageDrawable(null);
		fiximage2.setImageDrawable(null);
		fiximage3.setImageDrawable(null);
		fiximage4.setImageDrawable(null);
		fiximage5.setImageDrawable(null);
		fiximage6.setImageDrawable(null);
		fiximage7.setImageDrawable(null);
		fiximage8.setImageDrawable(null);
		text.setVisibility(View.INVISIBLE);
	}
